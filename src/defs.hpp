...
#define COUNT_GRID_FLOP
#define COUNT_GRID_FLOP_INNER          // 22
#define COUNT_GRID_FLOP_LEAF           // 12
#define COUNT_GRID_FLOP_MULTI_MULTI    // 28
#define COUNT_GRID_FLOP_MULTI_MONO     // 35
#define COUNT_GRID_FLOP_MONO_MULTI     // 25
#define COUNT_GRID_FLOP_MONO_MONO      // 8
