...
namespace fmm {
    ...
    void m2m_kernel::blocked_interaction_rho(struct_of_array_data<real, 20, ENTRIES_PADDED,
                                                 SOA_PADDING>& __restrict__ local_expansions_SoA,
        struct_of_array_data<real, 3, ENTRIES_PADDED,
            SOA_PADDING>& __restrict__ center_of_masses_SoA,
        struct_of_array_data<real, 20, ENTRIES_NOT_PADDED,
            SOA_PADDING>& __restrict__ potential_expansions_SoA,
        struct_of_array_data<real, 3, ENTRIES_NOT_PADDED,
