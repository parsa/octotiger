...
namespace fmm {
    ...
    void m2m_kernel::blocked_interaction_rho(
        ...
        struct_of_array_data<real, 20, ENTRIES, SOA_PADDING>& __restrict__ potential_expansions_SoA,
        struct_of_array_data<real, 3, ENTRIES, SOA_PADDING>& __restrict__ angular_corrections_SoA,
