...
// this is a change
__global__ void trivial_kernel(double* local_expansions_SoA_ptr, double* center_of_masses_SoA_ptr,
    double* potential_expansions_SoA_ptr, double* angular_corrections_SoA_ptr) {
...
namespace fmm {
    namespace cuda {
        ...
        // __global__ void blocked_interaction_rho(
        ...
        // 						       cell_index.y + stencil_element.y, cell_index.z +
        // stencil_element.z);
        ...
        // 	  multiindex<m2m_int_vector>
        // interaction_partner_index_coarse(interaction_partner_index);
        ...
        // 								   m_partner[0] /
        // local_expansions_SoA.value<0>(cell_flat_index);
        ...
        // 	  D_upper[0] =
        // 								   D_calculator.X[0] * D_calculator.X[0] * D_calculator.d3 +
        // 2.0
        // *
        // D_calculator.d2;
        ...
        // 	  m2m_vector n0_tmp =
        // 								   m_partner[10] -
        // local_expansions_SoA.value<10>(cell_flat_index)
        // *
        // n0_constant;
        // 	  // m_cell_iterator++; // 11
        ...
        // 	  n0_tmp = m_partner[11] - local_expansions_SoA.value<11>(cell_flat_index) *
        // n0_constant;
        ...
        // 	  n0_tmp = m_partner[12] - local_expansions_SoA.value<12>(cell_flat_index) *
        // n0_constant;
        ...
        // 	  n0_tmp = m_partner[13] - local_expansions_SoA.value<13>(cell_flat_index) *
        // n0_constant;
        ...
        // 	  n0_tmp = m_partner[14] - local_expansions_SoA.value<14>(cell_flat_index) *
        // n0_constant;
        ...
        // 	  n0_tmp = m_partner[15] - local_expansions_SoA.value<15>(cell_flat_index) *
        // n0_constant;
        ...
        // 	  D_upper[10] =
        // 								   D_calculator.X[1] * D_calculator.X[1] * D_calculator.d3 +
        // 2.0
        // *
        // D_calculator.d2;
        ...
        // 	  n0_tmp = m_partner[16] - local_expansions_SoA.value<16>(cell_flat_index) *
        // n0_constant;
        ...
        // 	  n0_tmp = m_partner[17] - local_expansions_SoA.value<17>(cell_flat_index) *
        // n0_constant;
        ...
        // 	  n0_tmp = m_partner[18] - local_expansions_SoA.value<18>(cell_flat_index) *
        // n0_constant;
        ...
        // 	  D_upper[14] =
        // 								   D_calculator.X[2] * D_calculator.X[2] * D_calculator.d3 +
        // 2.0
        // *
        // D_calculator.d2;
        ...
        // 	  n0_tmp = m_partner[19] - local_expansions_SoA.value<19>(cell_flat_index) *
        // n0_constant;
        ...
        // __global__ void blocked_interaction_non_rho(
        ...
        // 	  m2m_vector tmp = potential_expansions_SoA.value<0>(cell_flat_index_unpadded) +
        // cur_pot[0];
        // 	  Vc::where(mask, tmp).memstore(
        // 					potential_expansions_SoA.pointer<0>(cell_flat_index_unpadded),
        // 					Vc::flags::element_aligned);
