...
hpx::future<hpx::util::tuple<real, op_stats_t<set_basis>>>
node_client::step(integer steps) const {
    return hpx::async<typename node_server::step_action>(get_unmanaged_gid(), steps);
}

op_stats_t<set_basis> node_server::refined_step() {
...
hpx::future<op_stats_t<set_basis>> node_server::nonrefined_step() {
#if HPX_HAVE_ITTNOTIFY != 0 && !defined(HPX_HAVE_APEX)
    ...
    grid_ptr->store();
    hpx::future<op_stats_t<set_basis>> fut =
        hpx::make_ready_future(op_stats_t<set_basis>{});
    ...
    for (integer rk = 0; rk < NRK; ++rk) {
        ...
        fut = fut.then(
            hpx::util::annotated_function(
                [rk, cfl0, this, dt_fut](hpx::future<op_stats_t<set_basis>> f)
                    -> hpx::future<op_stats_t<set_basis>>
                {
                    op_stats_t<set_basis> s = f.get(); // propagate exceptions
                    ...
                    return fut_flux.then(
                        ...
                        hpx::util::annotated_function(
                            [s, rk, this, dt_fut](hpx::future<void> f)
                                -> op_stats_t<set_basis>
                            {
    ...
    return fut.then(hpx::launch::sync,
        [this](hpx::future<op_stats_t<set_basis>>&& f)
        {
            op_stats_t<set_basis> s = f.get(); // propagate exceptions...
            update();
            return s;
...
hpx::future<hpx::util::tuple<real, op_stats_t<set_basis>>>
node_server::local_step(integer steps) {

    hpx::future<hpx::util::tuple<real, op_stats_t<set_basis>>> dt_fut =
        hpx::make_ready_future(hpx::util::make_tuple(0.0, op_stats_t<set_basis>{}));
    for (integer i = 0; i != steps; ++i)
    {
        dt_fut = dt_fut.then(
            [this, i, steps](hpx::future<hpx::util::tuple<real, op_stats_t<set_basis>>> dt_fut)
                -> hpx::future<hpx::util::tuple<real, op_stats_t<set_basis>>>
            {
                auto time_start = std::chrono::high_resolution_clock::now();
                ...
                return next_dt.then(
                    [s](hpx::future<real> next_dt_)
                        -> hpx::util::tuple<real, op_stats_t<set_basis>>
                    {
                        return hpx::util::make_tuple(next_dt_.get(), s);
                    });
            });
    }
    return dt_fut;
...
hpx::future<hpx::util::tuple<real, op_stats_t<set_basis>>>
node_server::step(integer steps) {
    grid_ptr->set_coordinates();

    std::array<hpx::future<hpx::util::tuple<real, op_stats_t<set_basis>>>, NCHILD>
        child_futs;
    ...
    if (is_refined)
    {
        return hpx::dataflow(hpx::launch::sync,
            [this](hpx::future<hpx::util::tuple<real, op_stats_t<set_basis>>> dt_fut
                 , hpx::future<decltype(child_futs)>&& f)
            {
                auto child_futs = f.get(); // propagate exceptions

                hpx::util::tuple<real, op_stats_t<set_basis>> dt_and_s(dt_fut.get());
...
hpx::future<hpx::util::tuple<real, op_stats_t<set_basis>, diagnostics_t> >
node_client::step_with_diagnostics(integer steps,
...
hpx::future<hpx::util::tuple<real, op_stats_t<set_basis>, diagnostics_t> > node_server::step_with_diagnostics(integer steps,
    const std::pair<space_vector, space_vector>& axis, const std::pair<real, real>& l1, real c1, real c2)
{
    if (is_refined)
    {
        std::array<hpx::future<hpx::util::tuple<real, op_stats_t<set_basis>, diagnostics_t> >, NCHILD>
            child_futs;
        for (integer ci = 0; ci != NCHILD; ++ci) {
        ...
        return hpx::dataflow(hpx::launch::sync,
            [](hpx::future<hpx::util::tuple<real, op_stats_t<set_basis>>> dt_fut,
               std::array<hpx::future<hpx::util::tuple<real, op_stats_t<set_basis>, diagnostics_t> >, NCHILD> && d)
                -> hpx::util::tuple<real, op_stats_t<set_basis>, diagnostics_t>
            {
                diagnostics_t diags;
                auto dt_and_s = dt_fut.get();
                op_stats_t<set_basis> s = hpx::util::get<1>(dt_and_s);
                for (auto& f : d)
                {
                    auto t = f.get();
                    s += hpx::util::get<1>(t);
                ...
                return hpx::util::make_tuple(
                    hpx::util::get<0>(dt_and_s), std::move(s), std::move(diags));
            },
    ...
    return hpx::dataflow(hpx::launch::sync,
            ...
            {
                auto dt_and_s = dt_fut.get();
                return hpx::util::make_tuple(hpx::util::get<0>(dt_and_s),
                    hpx::util::get<1>(dt_and_s), std::move(diags));
            },
...
hpx::future<hpx::util::tuple<real, op_stats_t<set_basis>, diagnostics_t> >
node_server::root_step_with_diagnostics(integer steps)
{
    ...
    hpx::future<hpx::util::tuple<real, op_stats_t<set_basis>, diagnostics_t> > fut =
        step_with_diagnostics(steps, axis, l1, rho1.first, rho2.first);

    return fut.then(hpx::launch::sync,
        [=](hpx::future<hpx::util::tuple<real, op_stats_t<set_basis>, diagnostics_t> > f)
            ->  hpx::util::tuple<real, op_stats_t<set_basis>, diagnostics_t>
        {
            auto t = f.get();
            return hpx::util::make_tuple(
